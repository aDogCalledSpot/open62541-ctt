/*  Test prepared by nathan.pocock@opcfoundation.org
    Description: Insert multiple (5) values for multiple item in a single transaction; varied qualities */
...
function hainsertval() {
    ...
    for( var i=0; i<NUM_ITEMS; i++ ) {
        ...
        for( var v=0; v<NUM_VALUES; v++ ) {
            haparams.HistoryUpdateDetails[i].UpdateValues[v] = UaDataValue.New( { StatusCode: ( v % 2 == 1? StatusCode.Bad : StatusCode.Good ),
