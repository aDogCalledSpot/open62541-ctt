/*  Test 5.10.4 Error test 4 prepared by Matthias Isele; matthias.isele@ascolab.com
    Description: Acknowledge the same sequence number twice, in 2 different calls.
...
function publish5104Err004()
{
    ...
    if( MonitoredItems === null || MonitoredItems.length === 0 ) { addSkipped( "Static Scalar - 2 Nodes needed" ); }
...
Test.Execute( { Procedure: publish5104Err004 } );