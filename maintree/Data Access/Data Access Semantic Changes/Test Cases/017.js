...
function semanticChanges017() {
    ...
    if( !isDefined( items ) || items.length == 0 ) {
        addSkipped( "ImageItemType is not configured in /Server Test/NodeIds/Static/DA Profile/ArrayItemType/NDimensionArrayItemType. Please configure if supported." );
        return( false );
    }
