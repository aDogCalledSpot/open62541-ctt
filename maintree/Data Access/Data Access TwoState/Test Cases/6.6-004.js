/*  Test 6.6 Test 4; prepared by Nathan Pocock nathan.pocock@opcfoundation.org
...
function write66004()
{
    ...
    if( Assert.Equal( twoStateItems.length, originalValues.length, "Incorrect value count. Aborting test." ) )
    {
        ...
        {
            twoStateItems[w].Value.Value.setBoolean( (w % 2) );
            print( "\tAlternating value of originalItem[" + w + "] = " + twoStateItems[w].Value.Value.toBoolean() );
        }// for w...
