...
function write()
{
    ...
    // invoke the write
    if( !WriteHelper.Execute( { NodesToWrite: originalScalarItems, ReadVerification: false, SuppressMessaging: true } ) )
    {
...
var originalScalarItems = MonitoredItem.fromSettings( Settings.ServerTest.NodeIds.Static.AllProfiles.Arrays.Settings );
