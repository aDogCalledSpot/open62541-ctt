...
function GetDefaultReferencesOfTypeFromNodeId( nodeToBrowse, referenceTypeId, includeSubtypes, Session ) {
...
function GetBrowseResponseForOneReferenceOfType( Session, nodeToBrowse, referenceTypeId, includeSubtypes ) {
    var request = GetDefaultBrowseRequest( Session, nodeToBrowse );
